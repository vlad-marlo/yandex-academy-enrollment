...
func (s *Store) getCourierRegions(ctx context.Context, id int) (r []int, err error) {
	var rows pgx.Rows
...
func (s *Store) getCourierWorkingHours(ctx context.Context, id int) (r []*datetime.TimeInterval, err error) {
	var rows pgx.Rows
...
func (s *Store) GetCourierByID(ctx context.Context, id int) (courier *model.CourierDTO, err error) {
	courier = new(model.CourierDTO)
...
func (s *Store) getCouriers(ctx context.Context, ids []int) (res []model.CourierDTO, err error) {
